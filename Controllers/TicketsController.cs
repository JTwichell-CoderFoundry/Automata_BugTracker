...
namespace Automata_BugTracker.Controllers
{
    public class TicketsController : Controller
    {
        ...
        {                  
            return View(db.Tickets.Where(t => !t.Deleted).ToList());
        }
       ...
       // GET: Tickets
        ...
        {            
            return View("Index", TicketHelper.GetMyTickets());
        }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //A hard delete physically removes the record from the DB
            //db.Tickets.Remove(ticket);

            //A preferred method for auditing purposes is to perform a Soft Delete
            ticket.Deleted = true;
            db.SaveChanges();
            return RedirectToAction("Index");
        }
